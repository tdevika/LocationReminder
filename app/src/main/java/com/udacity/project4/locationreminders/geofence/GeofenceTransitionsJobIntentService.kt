...
class GeofenceTransitionsJobIntentService : JobIntentService(), CoroutineScope {
    ...
    private fun sendNotification(triggeringGeofences: List<Geofence>) {
        val requestId = when {
            ...
            {
                Log.d("GeofenceTransitionsJobIntentService", "sendNotification: " + triggeringGeofences[0].requestId)
                triggeringGeofences[0].requestId
            }

            else -> {
                Log.e("GeofenceTransitionsJobIntentService", "No Geofence Trigger Found !")
                return
            }
        }
